  ...
  return (
    <div className="md:mt-3 lg:mt-5">
      ...
      <div className="flex flex-col items-center text-center p-8 font-sans text-black">
        <div className="w-20 h-20 bg-yellow-400 flex items-end justify-end text-4xl m-3 p-2 font-extrabold font-recoleta">
          JS
        </div>
        <h1 className="text-lg md:text-xl lg:text-4xl font-bold mb-2">
          JavaScript
        </h1>
        <p className="text-sm md:text-xl lg:text-2xl text-gray-900  my-4">
          All job posts with the Tag{" "}
          <strong className="font-extrabold">JavaScript</strong>
        </p>

        <button className=" mt-7 text-2xl flex items-center gap-5 px-4 py-2 md:px-8 md:py-4 bg-custom-purple hover:bg-purple-500 text-white font-semibold rounded-lg transition duration-300">
          <FaBell /> Subscribe to tag
        </button>

        <p className="text-sm md:text-2xl text-gray-900 mt-8 gap-4 ">
